    ...
    <div className={'max-w-screen-xl mx-auto px-16 xl:px-0 bg-[length:32px]'}>
      ...
      >
        <div className={'flex gap-6 flex-col justify-between'}>
          ...
          >
            <div className={'text-transparent bg-clip-text bg-gradient-to-r from-accent to-secondary '}>Nodium</div>
            <div className={'text-dark-50 text-4xl font-jetbrains font-semibold dark:text-light'}> Веб разработка</div>
          </p>
        ...
        <CodeView className={'w-[320px] h-[280px] lg:w-[720px] lg:h-[420px] text-xs lg:text-base'}>
          ...
          <GrayBlock>()</GrayBlock>
          <br />
          <RedBlock>const</RedBlock> agile<TipBlock>:Agile</TipBlock> <GrayBlock>=</GrayBlock> <RedBlock>new</RedBlock>{' '}
          <AccentBlock>Agile</AccentBlock>
          <GrayBlock>
            (
            <DefaultBlock>
