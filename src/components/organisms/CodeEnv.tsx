  ...
  return (
    <div className={'w-full flex flex-col my-3'}>
      {!isSingle && (
        <div
          className={
            'h-9 flex text-[0.85rem] text-dark dark:text-light rounded-tl [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden overflow-x-auto [max-width:100%]'
          }
        >
          {groups.map((group, i) => (
            <div
